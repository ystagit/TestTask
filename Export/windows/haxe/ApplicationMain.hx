...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TestTask", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TestTask", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TestTask";
		app.meta["name"] = "TestTask";
		app.meta["packageName"] = "com.sample.testtask";
