...
class HXCPP_CLASS_ATTRIBUTES __ASSET__assets_fonts_arial_ttf_obj : public  ::lime::text::Font_obj
{
	public:
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"__ASSET__assets_fonts_arial_ttf"); }
		static ::hx::ObjectPtr< __ASSET__assets_fonts_arial_ttf_obj > __new();
		static ::hx::ObjectPtr< __ASSET__assets_fonts_arial_ttf_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("__ASSET__assets_fonts_arial_ttf",03,ee,f1,2d); }
