...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TestTask",d7,00,db,29),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("1067",e0,0f,88,20));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Company Name",4e,48,0d,cb));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TestTask",d7,00,db,29));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TestTask",d7,00,db,29));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.testtask",2e,77,2d,29));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TestTask",d7,00,db,29))
