...
#include <Reflect.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_arial_ttf
#include <__ASSET__OPENFL__assets_fonts_arial_ttf.h>
#endif
...
::shared::align::AlignType_obj::__register();
...
::shared::Color_obj::__register();
::scenes::root::Navigator_obj::__register();
::scenes::root::NavEvent_obj::__register();
...
::elements::tabs::TabListEvent_obj::__register();
::elements::snackbar::SnackbarEvent_obj::__register();
::elements::snackbar::Snackbar_obj::__register();
::elements::modal::ModalEvent_obj::__register();
::models::ModelEvent_obj::__register();
::openfl::events::Event_obj::__register();
::elements::ElementType_obj::__register();
::Xml_obj::__register();
...
::shared::size::Size_obj::__register();
::shared::align::Align_obj::__register();
::shared::Position_obj::__register();
::shared::Point_obj::__register();
::shared::Padding_obj::__register();
::shared::BoundingBox_obj::__register();
::scenes::root::RootSceneView_obj::__register();
::scenes::root::RootSceneController_obj::__register();
::scenes::root::RootScene_obj::__register();
...
::elements::text::TextView_obj::__register();
::elements::text::Text_obj::__register();
::elements::tabs::tab::TabView_obj::__register();
::elements::tabs::tab::Tab_obj::__register();
::elements::tabs::panel::TabPanelView_obj::__register();
::elements::tabs::panel::TabPanel_obj::__register();
::elements::tabs::context::TabContextView_obj::__register();
::elements::tabs::context::TabContext_obj::__register();
::elements::tabs::TabListView_obj::__register();
::elements::tabs::TabListController_obj::__register();
::elements::tabs::TabList_obj::__register();
::elements::snackbar::SnackbarView_obj::__register();
::elements::snackbar::SnackbarController_obj::__register();
::elements::scene::SceneView_obj::__register();
::elements::scene::Scene_obj::__register();
::elements::row::RowView_obj::__register();
::elements::row::Row_obj::__register();
::elements::modal::ModalView_obj::__register();
::elements::modal::Modal_obj::__register();
::elements::img_button::ImgButtonView_obj::__register();
::elements::img_button::ImgButton_obj::__register();
::elements::image::ImageView_obj::__register();
::elements::image::Image_obj::__register();
::elements::grid::GridView_obj::__register();
::elements::grid::Grid_obj::__register();
::elements::column::ColumnView_obj::__register();
::elements::column::Column_obj::__register();
::elements::button::ButtonView_obj::__register();
::views::GuiView_obj::__register();
::views::GuiComposite_obj::__register();
::views::GuiComponent_obj::__register();
::elements::button::Button_obj::__register();
::models::Model_obj::__register();
::models::IModel_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_arial_ttf_obj::__register();
...
::shared::align::AlignType_obj::__boot();
...
::Xml_obj::__boot();
::elements::ElementType_obj::__boot();
::openfl::events::Event_obj::__boot();
::models::ModelEvent_obj::__boot();
::elements::modal::ModalEvent_obj::__boot();
::elements::snackbar::Snackbar_obj::__boot();
::elements::snackbar::SnackbarEvent_obj::__boot();
::elements::tabs::TabListEvent_obj::__boot();
...
::scenes::root::NavEvent_obj::__boot();
::scenes::root::Navigator_obj::__boot();
::shared::Color_obj::__boot();
