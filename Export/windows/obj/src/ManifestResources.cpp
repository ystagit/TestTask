...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_arial_ttf >());
HXLINE(  57)		 ::Dynamic data;
HXDLIN(  57)		 ::Dynamic manifest;
HXDLIN(  57)		 ::Dynamic bundle;
HXLINE(  70)		{
HXLINE(  70)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  70)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  57)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  74)		if (::hx::IsNotNull( library )) {
HXLINE(  74)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  75)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
