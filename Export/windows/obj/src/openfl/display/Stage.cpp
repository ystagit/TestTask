...
HXLINE(1159)							dispatcher->_hx___dispatch(event);
            							...
            							if (_hx_e.IsClass<  ::Dynamic >() ){
            								HX_STACK_BEGIN_CATCH
            								 ::Dynamic _g = _hx_e;
HXLINE(1161)								 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1238)			return this->super::_hx___dispatchEvent(event);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1242)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1314)						i = (i - 1);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1321)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1334)			return target->_hx___dispatchEvent(event);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1336)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1728)			::openfl::ui::GameInput_obj::_hx___onGamepadAxisMove(gamepad,axis,value);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1730)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1744)			::openfl::ui::GameInput_obj::_hx___onGamepadButtonDown(gamepad,button);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1746)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1760)			::openfl::ui::GameInput_obj::_hx___onGamepadButtonUp(gamepad,button);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1762)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1776)			::openfl::ui::GameInput_obj::_hx___onGamepadConnect(gamepad);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1778)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE(1797)			::openfl::ui::GameInput_obj::_hx___onGamepadDisconnect(gamepad);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(1799)				 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
